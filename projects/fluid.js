...
async function createWasm() {
  ...
  var _emscripten_glGetProgramiv = (program, pname, p) => {
      ...
      if (pname == 0x8B84) { 
        ...
        if (!program.maxUniformLength) {
          var numActiveUniforms = GLctx.getProgramParameter(program, 0x8B86);
        ...
        if (!program.maxAttributeLength) {
          var numActiveAttributes = GLctx.getProgramParameter(program, 0x8B89);
        ...
        if (!program.maxUniformBlockNameLength) {
          var numActiveUniformBlocks = GLctx.getProgramParameter(program, 0x8A36);
      ...
      if (!ret) {
        switch (name_) {
          ...
          case 0x9246 :
            ...
            break;
          case 0x1F02 :
            var webGLVersion = GLctx.getParameter(0x1F02 );
            ...
            if (gamepad) {
              if (!GLFW.joys[joy]) {
                ...
                if (GLFW.joystickFunc) {
                  ((a1, a2) => dynCall_vii(GLFW.joystickFunc, a1, a2))(joy, 0x00040001); 
                }
              }
              ...
              if (GLFW.joys[joy]) {
                ...
                if (GLFW.joystickFunc) {
                  ((a1, a2) => dynCall_vii(GLFW.joystickFunc, a1, a2))(joy, 0x00040002); 
                }
  ...
  onDrop:(event) => {
        ...
        function save(file, in_path, numfiles) {
          var path = '/' + drop_dir + in_path + '/' + file.name.replace(/\
...
var ASM_CONSTS = {
  88670: () => { if (document.fullscreenElement) return 1; },  
 88716: () => { return Module.canvas.width; },  
 88748: () => { return parseInt(Module.canvas.style.width); },  
 88796: () => { document.exitFullscreen(); },  
 88823: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 88895: () => { if (document.fullscreenElement) return 1; },  
 88941: () => { return Module.canvas.width; },  
 88973: () => { return screen.width; },  
 88998: () => { document.exitFullscreen(); },  
 89025: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89219: () => { return window.innerWidth; },  
 89245: () => { return window.innerHeight; },  
 89272: () => { if (document.fullscreenElement) return 1; },  
 89318: () => { return Module.canvas.width; },  
 89350: () => { return parseInt(Module.canvas.style.width); },  
 89398: () => { if (document.fullscreenElement) return 1; },  
 89444: () => { return Module.canvas.width; },  
 89476: () => { return screen.width; },  
 89501: () => { return window.innerWidth; },  
 89527: () => { return window.innerHeight; },  
 89554: () => { if (document.fullscreenElement) return 1; },  
 89600: () => { return Module.canvas.width; },  
 89632: () => { return screen.width; },  
 89657: () => { document.exitFullscreen(); },  
 89684: () => { if (document.fullscreenElement) return 1; },  
 89730: () => { return Module.canvas.width; },  
 89762: () => { return parseInt(Module.canvas.style.width); },  
 89810: () => { document.exitFullscreen(); },  
 89837: ($0) => { Module.canvas.style.opacity = $0; },  
 89875: () => { return screen.width; },  
 89900: () => { return screen.height; },  
 89926: () => { return window.screenX; },  
 89953: () => { return window.screenY; },  
 89980: () => { return window.devicePixelRatio; },  
 90016: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90069: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90120: () => { Module.canvas.style.cursor = 'none'; },  
 90157: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90413: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90464: () => { if (document.pointerLockElement) return 1; },  
 90511: () => { if (document.fullscreenElement) return 1; },  
 90557: () => { return window.innerWidth; },  
 90583: () => { return window.innerHeight; }
};
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = FluidModule;
  module.exports.default = FluidModule;
