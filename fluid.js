...
var ASM_CONSTS = {
  88686: () => { if (document.fullscreenElement) return 1; },  
 88732: () => { return Module.canvas.width; },  
 88764: () => { return parseInt(Module.canvas.style.width); },  
 88812: () => { document.exitFullscreen(); },  
 88839: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 88911: () => { if (document.fullscreenElement) return 1; },  
 88957: () => { return Module.canvas.width; },  
 88989: () => { return screen.width; },  
 89014: () => { document.exitFullscreen(); },  
 89041: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89235: () => { return window.innerWidth; },  
 89261: () => { return window.innerHeight; },  
 89288: () => { if (document.fullscreenElement) return 1; },  
 89334: () => { return Module.canvas.width; },  
 89366: () => { return parseInt(Module.canvas.style.width); },  
 89414: () => { if (document.fullscreenElement) return 1; },  
 89460: () => { return Module.canvas.width; },  
 89492: () => { return screen.width; },  
 89517: () => { return window.innerWidth; },  
 89543: () => { return window.innerHeight; },  
 89570: () => { if (document.fullscreenElement) return 1; },  
 89616: () => { return Module.canvas.width; },  
 89648: () => { return screen.width; },  
 89673: () => { document.exitFullscreen(); },  
 89700: () => { if (document.fullscreenElement) return 1; },  
 89746: () => { return Module.canvas.width; },  
 89778: () => { return parseInt(Module.canvas.style.width); },  
 89826: () => { document.exitFullscreen(); },  
 89853: ($0) => { Module.canvas.style.opacity = $0; },  
 89891: () => { return screen.width; },  
 89916: () => { return screen.height; },  
 89942: () => { return window.screenX; },  
 89969: () => { return window.screenY; },  
 89996: () => { return window.devicePixelRatio; },  
 90032: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90085: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90136: () => { Module.canvas.style.cursor = 'none'; },  
 90173: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90429: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90480: () => { if (document.pointerLockElement) return 1; },  
 90527: () => { if (document.fullscreenElement) return 1; },  
 90573: () => { return window.innerWidth; },  
 90599: () => { return window.innerHeight; }
};
